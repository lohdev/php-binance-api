...
I have included all files needed for this to work, including the php-binance-api files.
I just wanted to share this, as I and many others have found it nice to have stoploss + PT's 
in Binance. This tool will cancel all orders for a coin and then sell into BTC (or the pair you set)
when price dips below stoploss-price for 3 seconds (or first new trade after 3 seconds)

This guide is for Windows, but it should be simple to change this to work on Linux.
